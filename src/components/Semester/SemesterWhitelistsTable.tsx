...
const SemesterWhitelistsTable: FC<SemesterWhitelistsTableProps> = ({ whitelists = [], isLoading = false, headerAction, onUpdate }) => {
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        {user.roleName === 'Lecturer' && (
                                            <button
                                                ...
                                                className={`text-xs font-bold px-3 py-1.5 rounded-lg border transition-all flex items-center gap-1 ml-auto ${user.isReviewer
