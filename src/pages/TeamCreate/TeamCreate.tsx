            ...
            <main className="flex flex-1 justify-center py-12 px-4">
                <div className="layout-content-container flex flex-col max-w-[600px] flex-1">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="flex h-9 items-center justify-center gap-x-2 rounded-full bg-[#F26F21]/10 dark:bg-[#F26F21]/20 px-4 border border-[#F26F21]/20">
                    ...
                    <div className="space-y-4 mb-10">
                        <div className="flex flex-col gap-4">
                            <label className="flex flex-col w-full">
                                <input
                                    className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-neutral-dark dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#F26F21]/50 border border-[#e5e7eb] dark:border-[#3d2c21] bg-white dark:bg-[#1a110a] h-24 placeholder:text-[#9e6b47] px-6 text-lg font-normal leading-normal transition-all"
